        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('admin.master.customer.create') }}" class="btn btn-success btn-sm float-right" title="Add New Supplier">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="project-actions text-right">
                                    <a class="btn btn-primary btn-sm" href="{{route('admin.master.customer.show',$customer->id)}}">
                                        <i class="fas fa-folder">
                                        </i>
                                        View
                                    </a>
                                    <a class="btn btn-info btn-sm" href="{{route('admin.master.customer.edit',$customer->id)}}">
