            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('admin.transaksi.kontrakjual.create') }}" class="btn btn-success btn-sm float-right"
                            title="Add New Kontrak">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                @foreach ($kontrakjuals as $kontrakjual)
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            ...
                                            <a class="btn btn-info btn-sm"
                                                href="{{ route('admin.transaksi.kontrakjual.edit', $kontrakjual->id) }}">
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                                Edit
                                            </a>
                                            <button type="button" data-toggle="modal"
                                                data-target="#delete{{ $kontrakjual->id }}"
                                    ...
                                    <x-confirm-delete :id="$kontrakjual->id" :route="route('admin.transaksi.kontrakjual.destroy', $kontrakjual->id)" :model="$kontrakjual"
                                        :modelAttribute="'no'" />
                                    <x-payment :id="$kontrakjual->id" :route="route('admin.transaksi.payment.kontrakjual.store', $kontrakjual->id)" :model="$kontrakjual" :kontrak="'kontrak_jual_id'"
                                        :modelAttribute="'no'" />
                                @endforeach
                            </tbody>
                        </table>
